...
class Uploader
{
    ...
    function saveImgData()
    {
        ...
        if (false === $pos) {
            return Uploader::FILE_NOT_SUPPORT;
        }
        ...
        if ($this->fixed_id) {
            ...
            $oripath = $dstpath . Uploader::FOLDER_ORI . '/' . $filecode . $extpart;
            $stardardpath = $dstpath . Uploader::FOLDER_STANDARD . '/' . $filecode . $extpart;
            $thumbpath = $dstpath . Uploader::FOLDER_THUMB . '/' . $filecode . $extpart;
        } else {
            $filecode = date('d_His') . '_' . randstr();
            $oripath = $img_dir . Uploader::FOLDER_ORI . '/' . date('Ym') . '/'. $filecode . $extpart;
            $stardardpath = $img_dir . Uploader::FOLDER_STANDARD . '/' . date('Ym') . '/'. $filecode . $extpart;
            $thumbpath = $img_dir . Uploader::FOLDER_THUMB . '/' . date('Ym') . '/'. $filecode . $extpart;
        }
        ...
        if (! $oripath || empty($oripath)) {
            return Uploader::FILE_UPLOAD_ERROR;
        }
        return array(
            'oripath' => $oripath,
    ...
    public function buildUploadResult($result)
    {
        ...
        if (is_numeric($result)) {
            if ($result == Uploader::FILE_NOT_SUPPORT) {
